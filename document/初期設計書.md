...
| DDB     | **DynamoDB** (single‑table)          | On‑Demand                   | チャットログ & Draft & Meta & Counter                                                                                                      | Streams → Kinesis Firehose to S3                                                                       |
...
| GH‑WH  | **GitHub Webhook**                | pull\_request, issue      | EventBridge SaaS 連携                      | HMAC 検証は自動                 |
